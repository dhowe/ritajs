...
describe('Core', () => {
  ...
  it('Should call addTransform', function () {
    let addRhyme = function (word) {
      let res = RiTa.lexicon.rhymesSync(word, { limit: 1 });    // get the rhymes
  ...
  it('Should call randomOrdering', function () {
    ...
    let ro = RiTa.randomOrdering(4); //(also remove util-tests.js)
  ...
  0 && it('Should call getTransforms', function () {
